                    ...
                    <div class="row">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <ul>
                                    <li>You can only set assignments for the subjects you teach.</li>
                                    <li>If none of the subjects you teach appear here contact your Administrator.</li>
                                    <li>Click on the class you want to edit your assignments.</li>
                                </ul>
                            </div>
                        </div>
                        <!-- Recent Sales -->
                                                    ...
                                                    <td style="min-width: 100px;">
                                                        @for ($i_1 = 0; $i_1 < count($subjects_taught[$i]->class_taught); $i_1++)
                                                            @if ($i_1 + 1 == count($subjects_taught[$i]->class_taught))
                                                                <a class="my-1" href='/Teacher/Assignments/{{ $subjects_taught[$i]->subject_id }}/Create/{{ $subjects_taught[$i]->real_class_names[$i_1] }}'
                                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                                    title="Click Me to Create assignments for {{ $subjects_taught[$i]->display_name }}, {{ $subjects_taught[$i]->class_taught[$i_1] }}">{{ $subjects_taught[$i]->class_taught[$i_1] }}</a>
                                                            @else
                                                                <a class="my-1" href='/Teacher/Assignments/{{ $subjects_taught[$i]->subject_id }}/Create/{{ $subjects_taught[$i]->real_class_names[$i_1] }}'
                                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                                    title="Click Me to Create assignments for {{ $subjects_taught[$i]->display_name }}, {{ $subjects_taught[$i]->class_taught[$i_1] }}">{{ $subjects_taught[$i]->class_taught[$i_1] }}</a>
