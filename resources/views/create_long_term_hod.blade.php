...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Create Long Term Lesson Plan - {{ $subject_details->display_name }} : {{ $get_class_name }} <button class="btn btn-sm btn-primary">H.O.D Section</button></h1>
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item "><a href="/Teacher/HOD/Create/Lessonplan/{{$lesson_id}}/Class/{{$class}}">Manage Lesson Plan - {{$subject_details->display_name}} : {{$get_class_name}}</a></li>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="row col-md-6 rounded p-1 border border-primary rounded ">
                                ...
                                <a href="/Teacher/ChangeStatus/{{$lesson_plan_id}}/{{$lesson_id}}/{{$class}}" class="btn btn-success btn-sm my-1"><i class="bi bi-arrow-clockwise"></i> Change Status</a>
                            </div>
                            <hr>
