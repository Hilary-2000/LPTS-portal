    ...
    <main id="main" class="main">
        ...
        <section class="section dashboard">
            ...
            <div class="row">
                ...
                {{-- <div class="col-lg-4">
                    <div class="container border border-primary shadow-lg border-3 p-2 rounded">
                        <h6 class="bg-success p-2 text-center text-white">Week #1 </h6>
                        <label for="week_objective_1" class="form-label"><b>Week #1 Objective</b>  <button id="btn_week_1" class="btn btn-primary btn-sm"><i class="bi bi-plus"></i> Add</button></label>
                        <div class="hide border border-success rounded p-1" id="week_objective_window_1">
                            <label for="week_objective_1" class="form-label">Week #1 Objectives</label>
                            <input type="text" class="form-control" id="week_objective_1" placeholder="Students should be able to...">
                            <button class="btn btn-primary my-1" id="btn_save_obj_1"><i class="bi bi-save"></i> Save</button>
                        </div>
                        <ul class="list-group">
                            <li class="list-group-item">1. This is the first item's accordion body. It is hidden by default.</li>
                            <li class="list-group-item">2. A second item</li>
                            <li class="list-group-item">3. A third item</li>
                        </ul>
                        <hr>
                        <label for="week_resources_1" class="form-label"><b>Week #1 Resources</b>  <button id="btn_resource_wk_1" class="btn btn-primary btn-sm"><i class="bi bi-plus"></i> Add</button></label>
                        <div class="hide border border-success rounded p-1" id="resources_week_1">
                            <label for="week_resources_1" class="form-label">Week #1 Resources</label>
                            <input type="text" class="form-control" id="week_resources_1" placeholder="KLB Pg 1-11...">
                            <button class="btn btn-primary my-1" id="btn_save_res_1"><i class="bi bi-save"></i> Save</button>
                        </div>
                        <ul class="list-group">
                            <li class="list-group-item">1. This is the first item's accordion body. It is hidden by default.</li>
                            <li class="list-group-item">2. A second item</li>
                        ...
                        <hr>
                        <label for="week_activities_1" class="form-label"><b>Week #1 Activities</b>  <button id="btn_activity_wk_1" class="btn btn-primary btn-sm"><i class="bi bi-plus"></i> Add</button></label>
                        <div class="hide border border-success rounded p-1" id="activity_week_1">
                            <label for="week_activities_1" class="form-label">Week #1 Activities</label>
                            <input type="text" class="form-control" id="week_activities_1" placeholder="Creation of visual aids...">
                            <button class="btn btn-primary my-1" id="btn_save_act_1"><i class="bi bi-save"></i> Save</button>
                        </div>
                        <ul class="list-group">
                            <li class="list-group-item">1. This is the first item's accordion body. It is hidden by default.</li>
                            <li class="list-group-item">2. A second item</li>
                        ...
                        <hr>
                        <label for="week_comments_1" class="form-label"><b>Week #1 Comment:</b>  <button id="btn_comments_wk_1" class="btn btn-primary btn-sm"><i class="bi bi-plus"></i> Add</button></label>
                        <div class="hide border border-success rounded p-1" id="comments_week_1">
                            <label for="week_comments_1" class="form-label">Week #1 Activities</label>
                            <textarea name="week_comments_1" id="week_comments_1" cols="30" rows="5" class="form-control" placeholder="Comment here.."></textarea>
                            <button class="btn btn-primary my-1" id="btn_save_comments_1"><i class="bi bi-save"></i> Save</button>
                        </div>
                        <ul class="list-group">
                            <li class="list-group-item">1. This is the first item's accordion body. It is hidden by default.</li>
                            <li class="list-group-item">2. A second item</li>
                        ...
                        <div class="container w-100 my-2 p-0">
                            <button class="btn btn-primary btn-block w-100"><i class="bi bi-save"></i> Save</button>
                        </div>
                    </div>
                </div><!-- End Left side columns --> --}}
                {{-- <div class="col-lg-4">
                    <div class="container border border-secondary p-2 shadow-lg rounded">
                        <h6 class="bg-white p-2 text-center">Week #2 </h6>

                        <label for="week_objective_2" class="form-label"><b>Week #2 Objective</b>  <button id="btn_week_2" class="btn btn-primary btn-sm"><i class="bi bi-plus"></i> Add</button></label>
                        <div class="hide border border-success rounded p-1" id="week_objective_window_2">
                            <label for="week_objective_2" class="form-label">Week #2 Objectives</label>
                            <input type="text" class="form-control" id="week_objective_2" placeholder="Students should be able to...">
                            <button class="btn btn-primary my-1" id="btn_save_obj_2"><i class="bi bi-save"></i> Save</button>
                        </div>
                        <ul class="list-group">
                            <li class="list-group-item">1. This is the first item's accordion body. It is hidden by default.</li>
                            <li class="list-group-item">2. A second item</li>
                        ...
                        <hr>
                        <label for="week_resources_2" class="form-label"><b>Week #2 Resources</b>  <button id="btn_resource_wk_2" class="btn btn-primary btn-sm"><i class="bi bi-plus"></i> Add</button></label>
                        <div class="hide border border-success rounded p-1" id="resources_week_2">
                            <label for="week_resources_2" class="form-label">Week #2 Resources</label>
                            <input type="text" class="form-control" id="week_resources_2" placeholder="KLB Pg 1-11...">
                            <button class="btn btn-primary my-1" id="btn_save_res_2"><i class="bi bi-save"></i> Save</button>
                        </div>
                        <ul class="list-group">
                            <li class="list-group-item">1. This is the first item's accordion body. It is hidden by default.</li>
                            <li class="list-group-item">2. A second item</li>
                        ...
                        <hr>
                        <label for="week_activities_2" class="form-label"><b>Week #2 Activities</b>  <button id="btn_activity_wk_2" class="btn btn-primary btn-sm"><i class="bi bi-plus"></i> Add</button></label>
                        <div class="hide border border-success rounded p-1" id="activity_week_2">
                            <label for="week_activities_2" class="form-label">Week #2 Activities</label>
                            <input type="text" class="form-control" id="week_activities_2" placeholder="Creation of visual aids...">
                            <button class="btn btn-primary my-1" id="btn_save_act_2"><i class="bi bi-save"></i> Save</button>
                        </div>
                        <ul class="list-group">
                            <li class="list-group-item">1. This is the first item's accordion body. It is hidden by default.</li>
                            <li class="list-group-item">2. A second item</li>
                        ...
                        <hr>
                        <label for="week_comments_2" class="form-label"><b>Week #1 Comment:</b>  <button id="btn_comments_wk_2" class="btn btn-primary btn-sm"><i class="bi bi-plus"></i> Add</button></label>
                        <div class="hide border border-success rounded p-1" id="comments_week_2">
                            <label for="week_comments_2" class="form-label">Week #1 Activities</label>
                            <textarea name="week_comments_2" id="week_comments_2" cols="30" rows="5" class="form-control" placeholder="Comment here.."></textarea>
                            <button class="btn btn-primary my-1" id="btn_save_comments_2"><i class="bi bi-save"></i> Save</button>
                        </div>
                        <ul class="list-group">
                            <li class="list-group-item">1. This is the first item's accordion body. It is hidden by default.</li>
                            <li class="list-group-item">2. A second item</li>
                ...
                {{-- <div class="col-lg-4">
                    <div class="container border border-secondary shadow-lg p-2 rounded">
                        <h6 class="bg-white p-2 text-center">Week #3 </h6>

                        <label for="week_objective_3" class="form-label"><b>Week #3 Objective</b>  <button id="btn_week_3" class="btn btn-primary btn-sm"><i class="bi bi-plus"></i> Add</button></label>
                        <div class="hide border border-success rounded p-1" id="week_objective_window_3">
                            <label for="week_objective_3" class="form-label">Week #3 Objectives</label>
                            <input type="text" class="form-control" id="week_objective_3" placeholder="Students should be able to...">
                            <button class="btn btn-primary my-1" id="btn_save_obj_3"><i class="bi bi-save"></i> Save</button>
                        </div>
                        <ul class="list-group">
                            <li class="list-group-item">1. This is the first item's accordion body. It is hidden by default.</li>
                            <li class="list-group-item">2. A second item</li>
                        ...
                        <hr>
                        <label for="week_resources_3" class="form-label"><b>Week #3 Resources</b>  <button id="btn_resource_wk_3" class="btn btn-primary btn-sm"><i class="bi bi-plus"></i> Add</button></label>
                        <div class="hide border border-success rounded p-1" id="resources_week_3">
                            <label for="week_resources_3" class="form-label">Week #3 Resources</label>
                            <input type="text" class="form-control" id="week_resources_3" placeholder="KLB Pg 1-11...">
                            <button class="btn btn-primary my-1" id="btn_save_res_3"><i class="bi bi-save"></i> Save</button>
                        </div>
                        <ul class="list-group">
                            <li class="list-group-item">1. This is the first item's accordion body. It is hidden by default.</li>
                            <li class="list-group-item">2. A second item</li>
                        ...
                        <hr>
                        <label for="week_activities_3" class="form-label"><b>Week #3 Activities</b>  <button id="btn_activity_wk_3" class="btn btn-primary btn-sm"><i class="bi bi-plus"></i> Add</button></label>
                        <div class="hide border border-success rounded p-1" id="activity_week_3">
                            <label for="week_activities_3" class="form-label">Week #3 Activities</label>
                            <input type="text" class="form-control" id="week_activities_3" placeholder="Creation of visual aids...">
                            <button class="btn btn-primary my-1" id="btn_save_act_3"><i class="bi bi-save"></i> Save</button>
                        </div>
                        <ul class="list-group">
                            <li class="list-group-item">1. This is the first item's accordion body. It is hidden by default.</li>
                            <li class="list-group-item">2. A second item</li>
                        ...
                        <form action="/updateMediumPlan" method="post" class="container my-2 p-0">
                            <input type="hidden" name="hold_data" id="hold_data_" value="">
                            <button type="submit" class="btn btn-primary btn-block w-100"><i class="bi bi-save"></i> Save</button>
                        </div>
                    </div>
                </div> --}}
