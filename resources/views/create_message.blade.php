...
<head>
    ...
    <title>Create Message & Alerts </title>
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Create Message & Alerts</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="row">
                        <div class="card">
                            <div class="card-body">
                                <a href="/Teacher/Messages" class="btn btn-secondary btn-sm my-2"><i class="bi bi-arrow-left"></i> Message & Alerts</a>
                                <h5 class="card-title">Note:</h5>
                                <ul>
                                    <li>Create alerts for parents teachers and students.</li>
                        ...
                        <div class="col-12">
                            <div class="card recent-sales overflow-auto">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-10">
                                            <h5 class="card-title">Create Alerts</h5>
                                        </div>
                                        <div class="col-md-2">
                                            <a href="/Teacher/Messages/Manage" class="btn btn-secondary btn-sm my-2"><i class="bi bi-gear"></i> Manage My Alerts</a>
                                        </div>
                                    </div>
                                    ...
                                    <form method="POST" action="/Teacher/SaveAlert" class="row my-2 p-1">
                                        @csrf
                                        <div class="col-md-12 p-1">
                                            <label for="notice_title" class="form-label"><b>Notice Title</b></label>
                                            <input required type="text" value="" class="form-control" name="notice_title" id="notice_title" placeholder="Ex. CLosing Day">
                                        </div>
                                        <div class="col-md-12 p-1">
                                            <label for="notice_body" class="form-label"><b>Notice Message</b></label>
                                            <textarea  name="notice_body" id="notice_body" cols="30" rows="5" placeholder="Ex. We will be breaking for the term two holiday. Kindly ensure that all the students are home safe" class="form-control border border-secondary rounded tinymce-editor"></textarea>
                                        </div>
                                        <div class="col-md-12 p-1">
                                            <label for="message_recipient" class="form-label"><b>Message recipient</b></label>
                                            <select required name="message_recipient" id="message_recipient" class="form-control">
                                                <option value="" hidden>Select recipient</option>
                                                <option value="parent">Parents</option>
                                                <option selected value="teacher">Teachers</option>
                                        ...
                                        <div class="col-md-12 p-1">
                                            ...
                                            <select required name="message_status" id="message_status" class="form-control">
                                                <option value="" hidden>Select Message Status</option>
                                                <option selected value="Drafted">Drafted</option>
                                                <option value="Published">Published</option>
                                            </select>
                                        </div>
                                        <div class="col-md-4 p-1">
                                            <button type="submit" class="btn btn-success btn-sm w-100"><i class="bi bi-plus"></i> Save</button>
                                        </div>
                                    </form>
                                </div>
