...
<head>
    ...
    <title>H.O.D Lesson Plan Manager - {{$subject_details->display_name}} -
...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Create Lesson Plan - {{$subject_details->display_name}} : {{$get_class_name}} <button class="btn btn-sm btn-primary">H.O.D Section</button></h1>
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item "><a href="/Teacher/HOD/LessonPlan">H.O.D Lesson Plan Manager</a></li>
                    <li class="breadcrumb-item active">Manage Lesson Plan - {{$subject_details->display_name}} : {{$get_class_name}}</li>
                </ol>
            </nav>
            <a href="/Teacher/HOD/LessonPlan" class="btn btn-secondary"><i class="bi bi-arrow-left"></i> Subjects I teach</a>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="my-0"><b>Teacher Assigned :</b> {{$staff_name}}</p>
                            <p class="my-0"><b>Subject Name :</b> {{ucwords(strtolower($subject_details->subject_name))}} </p>
                            <p class="my-0"><b>Subject Display Name :</b> {{$subject_details->display_name}}</p>
                            <p class="my-0"><b>Subject Class Name :</b> {{$get_class_name}}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">Long Term Lesson Plan</h5>
                                    <p>This plan will consist of all <b>{{$subject_details->display_name}}</b> objectives that you will teach this academic year. This objectives are usually classified under <b>Strand/Topics</b> and <b>Sub-Strands/Sub-topics</b> and <b>objectives.</b></p>

                                    <!-- Basic Modal -->
                                    <a class="btn btn-primary" href="/Teacher/HOD/CreatePlan/Long/{{$lesson_id}}/class/{{$class}}">
                                        <i class="bi bi-pen"></i>
                                        Manage Plan
                                    </a>
                                </div>
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">Medium Term Lesson Plan</h5>
                                    <p>This <b>plan</b> is linked with the <b>Long Term Plan</b>, you will be able to create this plan reffering to the termly objectives that were defined in the long term plan. Furthermore you will be able to break the activities in <b>weekly format</b>, share the activities that will be done, objectives and the resources to be used.</p>
                                    <!-- Basic Modal -->
                                    <a class="btn btn-primary" href="/Teacher/HOD/CreatePlan/Medium/{{$lesson_id}}/class/{{$class}}">
                                        <i class="bi bi-pen"></i>
                                        Manage Plan
                                    </a>
                                </div>
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">Weekly Lesson Plan</h5>
                                    <p>This plan is linked with the <b>Medium Term Plan</b>, you will be able to breakdown the weekly activities of the medium term plan to daily activities. Furthermore  you will be able to define the objectives of that lesson and share learning materials like <i><b>(Videos, Notes & Powerpoint Presentations.)</b></i></p>
                                    <!-- Basic Modal -->
                                    <a class="btn btn-primary" href="/Teacher/HOD/CreatePlan/Weekly/{{$lesson_id}}/class/{{$class}}">
                                        <i class="bi bi-pen"></i>
                                        Manage Plan
                                    </a>
                                </div>
