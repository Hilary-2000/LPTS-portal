...
<head>
    ...
    <title>Create Lesson Plan - {{$subject_details->display_name}} -
...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Create Lesson Plan - {{$subject_details->display_name}} : {{$get_class_name}} </h1>
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Create Lesson Plan - {{$subject_details->display_name}} : {{$get_class_name}}</li>
                </ol>
            </nav>
            <a href="/Teacher/LessonPlan" class="btn btn-secondary"><i class="bi bi-arrow-left"></i> Subjects I teach</a>
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <!-- Basic Modal -->
                                    <a class="btn btn-primary" href="/Teacher/CreatePlan/Long/{{$lesson_id}}/class/{{$class}}">
                                        <i class="bi bi-pen"></i>
                                        Create Plan
                                    </a>
                                </div>
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <!-- Basic Modal -->
                                    <a class="btn btn-primary" href="/Teacher/CreatePlan/Medium/{{$lesson_id}}/class/{{$class}}">
                                        <i class="bi bi-pen"></i>
                                        Create Plan
                                    </a>
                                </div>
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <!-- Basic Modal -->
                                    <a class="btn btn-primary" href="/Teacher/CreatePlan/Weekly/{{$lesson_id}}/class/{{$class}}">
                                        <i class="bi bi-pen"></i>
                                        Create Plan
                                    </a>
                                </div>
