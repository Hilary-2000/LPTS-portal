                                        ...
                                        <tbody>
                                            @for ($i = 0; $i < count($students_data); $i++)
                                                <tr>
                                                    ...
                                                    <td style="min-width: 100px;">{{count($students_data[$i]->subject_taught)." Subject(s)"}}</td>
                                                    <td style="min-width: 100px;">{{count($students_data[$i]->active_exams)." Exam(s) Active"}} </td>
                                                    <td style="min-width: 100px;"><a href="/Parent/Peformance/View/{{$students_data[$i]->adm_no}}" class="btn btn-primary btn-sm"><i class="bi bi-eye"></i> View</a></td>
                                                </tr>
                                            @endfor
                                        </tbody>
                                    </table>
