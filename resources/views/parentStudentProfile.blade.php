...
<body>
    ...
    <main id="main" class="main">
        ...
        <a href="/Parent/Dashboard" class="btn btn-sm btn-secondary my-2"><i class="bi bi-arrow-left"></i> Back To Dashboard</a>
                ...
                <div class="col-xl-4">
                    ...
                    <div class="card">
                        <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                            ...
                            <img src="{{($student_data->student_image != null) ? 'https://lsims.ladybirdsmis.com/sims/'.$student_data->student_image : '/assets/img/dp.png'}}"
                                alt="Profile" class="rounded-circle">
                            <h2>{{ ucwords(strtolower($student_data->first_name." ".$student_data->second_name)) }}</h2>
                            <h3>Student</h3>
                            <p class="text-success">{{ session('valid') != null ? session('valid') : '' }}</p>
                            <p class="text-danger">{{ session('invalid') != null ? session('invalid') : '' }}</p>
                            <div class="row">
                                <div class="col-md-6 p-0 my-2"><a href="/Parent/View/StudentFeesDetails/{{$student_data->adm_no}}" class="btn btn-sm btn-primary"><i class="bi bi-currency-dollar"></i> Fees Balances</a></div>
                                <div class="col-md-6 p-0 my-2"><a href="/Parent/TrackAttendance/{{$student_data->adm_no}}" class="btn btn-sm btn-primary"><i class="bi bi-person-check-fill"></i> Track Attendance</a></div>
                                <div class="col-md-6 p-0 my-2"><a href="/Parent/Peformance/View/{{$student_data->adm_no}}" class="btn btn-sm btn-primary"><i class="bi bi-book-half"></i> Academic Perfomance</a></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body pt-3">
                            ...
                            <div class="tab-content pt-2">
                                ...
                                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-md-8" style="font-size:12px;">
                                            {{ ucwords(strtolower($student_data->first_name." ".$student_data->second_name)) }}</div>
                                    </div>

                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label" style="font-size:12px;">Date Of Birth</div>
                                        <div class="col-lg-9 col-md-8" style="font-size:12px;">
                                            {{date("D dS M Y",strtotime($student_data->D_O_B))}}
                                        </div>
                                    </div>

                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label" style="font-size:12px;">Date Of Admission</div>
                                        <div class="col-lg-9 col-md-8" style="font-size:12px;">
                                            {{date("D dS M Y",strtotime($student_data->D_O_A))}}
                                        </div>
                                    </div>

                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label" style="font-size:12px;">Gender</div>
                                        <div class="col-lg-9 col-md-8" style="font-size:12px;">
                                            {{$student_data->gender}}
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-md-8" style="font-size:12px;">
                                            {{ $student_data->address }}</div>
                                    </div>

                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label" style="font-size:12px;">Class</div>
                                        <div class="col-lg-9 col-md-8" style="font-size:12px;">
                                            {{ classNameAdms($student_data->stud_class)}}</div>
                                    </div>

                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label" style="font-size:12px;">Admission No.</div>
                                        <div class="col-lg-9 col-md-8" style="font-size:12px;">
                                            {{ $student_data->adm_no }}</div>
                                    </div>

                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label" style="font-size:12px;">Class Teacher.</div>
                                        <div class="col-lg-9 col-md-8" style="font-size:12px;">
                                            {{ $class_teacher }}</div>
                                    </div>

                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label" style="font-size:12px;">Fees Balance.</div>
                                        <div class="col-lg-9 col-md-8" style="font-size:12px;">
                                            <a href="/Parent/View/StudentFeesDetails/{{$student_data->adm_no}}">Kes {{ $student_data->stud_balance }} <i class="bi bi-box-arrow-up-right"></i></a></div>
                                    </div>

                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label" style="font-size:12px;">Student Attendance.</div>
                                        <div class="col-lg-9 col-md-8" style="font-size:12px;">
                                            @php
                                                $stats = $student_data->present_stats;
                                            @endphp
                                            {{ ($stats[0] != 0 && $stats[1] != 0) ? round(($stats[0]/$stats[1]) * 100) : "0"}}% {{("(".$stats[0]." out of ".$stats[1]." times)")}}</div>
                                    </div>
                                </div>
                                @php
                                    ...
                                    <form action="/Teacher/Updateprofile" method="POST">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <img src="{{($student_data->student_image != null) ? 'https://lsims.ladybirdsmis.com/sims/'.$student_data->student_image : 'https://lsims.ladybirdsmis.com/sims/assets/img/dp.png'}}"
                                                    alt="Profile" class="rounded-circle">
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane fade pt-3" id="profile-change-password">
                                    ...
                                    <form method="POST" action="/Student/UpdatePass">
                                        @csrf
                                        <input type="hidden" name="student_adm"
                                            value="{{ ucwords(strtolower($student_data->adm_no)) }}">
                                        <div class="row mb-3">
