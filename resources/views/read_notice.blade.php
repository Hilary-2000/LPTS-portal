        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="/Teacher/Messages">My Messages & Alerts</a>
                    </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card recent-sales overflow-auto">
                                <div class="card-body">
                                    <a href="/Teacher/Messages" class="btn btn-secondary btn-sm my-2"><i class="bi bi-arrow-left"></i>My Message & Alerts List</a>
                                    <div class="row">
                                        <div class="col-md-10">
