...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link " href="/Students/Messages">
                    <i class="bi bi-grid"></i>
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="/Students/Messages">My Messages & Alerts</a>
                    </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card recent-sales overflow-auto">
                                <div class="card-body">
                                    <a href="/Students/Messages" class="btn btn-secondary btn-sm my-2"><i class="bi bi-arrow-left"></i>My Message & Alerts List</a>
                                    <div class="row">
                                        <div class="col-md-10">
