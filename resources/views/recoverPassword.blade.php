            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="https://ladybirdsmis.com/" class=" d-flex align-items-center w-auto">
                  <img width="80" height="90" src="assets/img/ladybird.png" alt="">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                        ...
                        <select name="yourUserType" id="yourUserType" class="form-control">
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group has-validation">
                            ...
                            <input type="text" name="username" class="form-control" id="yourSchoolCode" required placeholder="Type School Name or Code">
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Already have an account? <a href="/Logout">Login</a></p>
                    </div>
                  </form>
