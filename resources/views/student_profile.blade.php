...
<head>
    ...
    <title>Student Profile -
        {{ session('student_information') != null ? ucwords(strtolower(session('student_information')->first_name . ' ' . session('student_information')->second_name)) : '' }}
    </title>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow notifications">
                        <li class="dropdown-header">
                            ...
                            <a href="/Students/Messages"><span class="badge rounded-pill bg-primary p-2 ms-2">View
                                    all</span></a>
                        </li>
                        @php
                        ...
                        @for ($i = 0; $i < count($student_notification); $i++)
                            <li class="notification-item">
                                ...
                                <a href="/Student/Alert/Read/{{ $student_notification[$i]->id }}">
                                    ...
                                    <p>{{ strlen(getInnerText($student_notification[$i]->message_body)) > 50 ? substr(getInnerText($student_notification[$i]->message_body), 0, 50) . '...' : getInnerText($student_notification[$i]->message_body) }}
                                    </p>
                            ...
                            <div class="tab-content pt-2">
                                ...
                                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-md-8" style="font-size:12px;">
                                            {{ ucwords(strtolower(session('school_information')->school_name)) }}</div>
                                    </div>
