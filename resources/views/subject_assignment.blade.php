        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Assignments - {{$subject_details[0]->display_name}} - {{$selected_class}}</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="row">
                        <div class="card">
                            <div class="card-body">
                                <a href="/Teacher/Assignment" class="btn btn-secondary btn-sm my-2"><i class="bi bi-arrow-left"></i> Subjects I Teach</a>
                                <h5 class="card-title">Note:</h5>
                                <ul>
                                    <li>Manage all your assignments from this section.</li>
                                    <li>The <b>Mark</b> button will appear only when the exam is published, while the <b>Set</b> button will appear when the exam is still on draft status.</li>
                                </ul>
                            </div>
                        </div>
                        <!-- Recent Sales -->
                        <div class="col-12">
                            <div class="card recent-sales overflow-auto">
                                <div class="card-body">
                                    <a href="/Create/Assignments/{{$subject_id}}/{{$class_name}}" class="btn btn-sm btn-success my-2"><i class="bi bi-plus"></i> Create Assignment for {{$subject_details[0]->display_name}} - {{$selected_class}}</a>
                                        ...
                                        <tbody>
                                            @for ($i = 0; $i < count($assignments); $i++)
                                                <tr>
                                                    ...
                                                    <td style="min-width: 100px;">{{isJson($assignments[$i]->period) ? date("D dS M Y",strtotime(json_decode($assignments[$i]->period)->start_date))." - ".date("D dS M Y",strtotime(json_decode($assignments[$i]->period)->end_date)) : "Invalid Period"}}</td>
                                                    <td style="min-width: 100px;">{{(isJson($assignments[$i]->questions) ? count(json_decode($assignments[$i]->questions)) : 0). " Question(s)."}}</td>
                                                    <td style="min-width: 100px;">{{date("D dS M Y",strtotime($assignments[$i]->date_created))}}</td>
                                                    ...
                                                    <td style="min-width: 100px;">
                                                        @if ($assignments[$i]->status == 0)
                                                            <a href="/Assignments/Set/{{$assignments[$i]->id}}" class="btn btn-sm btn-primary my-1"><i class="bi bi-list"></i> Set</a>
                                                        @else
                                                            <a href="/Assignments/Mark/{{$assignments[$i]->id}}" class="btn btn-sm btn-primary my-1"><i class="bi bi-check-all"></i> Mark</a>
                                                        @endif
                                                        <a href="/Assignments/Edit/{{$assignments[$i]->id}}" class="btn btn-sm btn-secondary my-1"><i class="bi bi-pen"></i> Edit</a>
                                                    </td>
                                                </tr>
                                            @endfor
                                        </tbody>
